...
from animations.clip_classes import VideoClip
...
def audio_tester():
    ...
    vclip.crop(aspect_ratio=aspect_ratios[4])
    ...
    vclip.write_video(filename=(aspect_ratios[4] + 'Test.mp4'))
    vclip.create_gif(filename="testgif.gif")

# <------------------------- Place method you wish to test here ------------------------->
# Example: audio_tester()
